...
class BastionHostStack(Stack):
  ...
  def __init__(self, scope: Construct, construct_id: str, vpc, **kwargs) -> None:
    ...
    cdk.CfnOutput(self, '{}_BastionHostId'.format(self.stack_name),
      value=bastion_host.instance_id, export_name='BastionHostId')
    cdk.CfnOutput(self, '{}_BastionHostPublicDNSName'.format(self.stack_name),
      value=bastion_host.instance_public_dns_name, export_name='BastionHostPublicDNSName')
